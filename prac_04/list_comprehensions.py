...
print("Numbers bigger than nine:", bigger_than_nine)
...
long_last_names = [name for name in last_names if len(name) >= max_length]
print("Long last names:", ", ".join(long_last_names))